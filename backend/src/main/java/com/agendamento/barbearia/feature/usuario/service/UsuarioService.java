...
/**
* Camada de serviço responsável pelo gerenciamento de contas de usuário, 
* criptografia de senhas e atribuição de perfis de acesso (Roles).
*/
...
public class UsuarioService {
  ...
  /**
  * Cria um novo usuário padrão. Caso o perfil escolhido seja BARBEIRO, 
  * um perfil profissional básico é gerado automaticamente e vinculado à conta.
  */
  ...
  /**
  * Método auxiliar utilizado pela Facade de registro para isolar a criação 
  * das credenciais de acesso (usuário/senha) de um novo barbeiro.
  */
